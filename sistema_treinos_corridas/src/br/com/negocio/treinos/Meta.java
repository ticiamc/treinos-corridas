...
public class Meta {
    ...
    // NOVO CAMPO para controlar o REQ20
    private boolean avisoProximidadeEnviado;
    ...
    public Meta(String descricao, double valorAlvo, TipoMeta tipoMeta, LocalDate dataInicio, LocalDate dataFim) {
        ...
        this.avisoProximidadeEnviado = false; // Inicializa como falso
    }
    ...
    public boolean isAvisoProximidadeEnviado() { return avisoProximidadeEnviado; }
    public void setAvisoProximidadeEnviado(boolean avisoProximidadeEnviado) { this.avisoProximidadeEnviado = avisoProximidadeEnviado; }
