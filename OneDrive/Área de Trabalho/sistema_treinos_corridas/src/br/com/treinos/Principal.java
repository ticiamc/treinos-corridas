...
public class Principal {
    public static void main(String[] args) {
        ...
        // 2. Registrando alguns treinos para a Rodrigo
        ...
        // Registrando treinos para Victoria
        ...
        desafioDezembro.getParticipacoes().get(0).setProgresso(20.5); // Rodrigo correu 20.5 km
        desafioDezembro.getParticipacoes().get(1).setProgresso(15.0); // Victoria correu 15.0 km

        // 5. Instanciando a classe de relatórios pra gerar as análises
        Relatorio relatorio = new Relatorio();

        System.out.println("### GERANDO RELATÓRIO DE ATIVIDADES PARA RODRIGO ###");
        ...
        System.out.println("### GERANDO RELATÓRIO DE EVOLUÇÃO PARA VICTORIA ###");
